...
<p className={genderlabel}>Gender:</p>
      ...
      <Input type="textarea" className={inputstyletextarea} pattern="[a-zA-Z0-9]{5,25}" required/>
    </div>
        <div class="form-row">
          <div class="col-md-5 mb-3">
            <label className={labelStyle1}>Nationality</label>
    <Input type="text"  className={inputstyle} placeholder="" pattern="[a-zA-z]{2,25}"  required/>
          </div>
          <div class="col-md-5 mb-3">
        ...
        <p className={pageHeading}>Emergency Contact Details</p>
          ...
          <Input type="text"  className={inputstyle} placeholder="Contact Person Name" pattern="[a-zA-Z]{5,25}" required/>
            </div>
            <div class="col-md-5 mb-3">
              <label className={labelStyle1}>Phone</label>
